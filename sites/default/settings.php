 ...
 *
 */
$drupal_hash_salt = '-ibmfaRos5zwIMb9mWCWzJ-VcFa342exk-KgBaUKKJc';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_confreg_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_confreg_dd.inc';
}
// </DDSETTINGS>
